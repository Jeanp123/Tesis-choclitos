...
\subsection{Tipo}
La investigación es de tipo no experimental, dado que se trabajará con datos históricos comprendidos entre el año 2012 Y 2026. A partir de este análisis, se desarrollará un modelo predictivo para mejorar la precisión en la estimación de la demanda de productos perecibles en Market Donna SAC y, así, orientar decisiones más efectivas. 
