...
\subsection{Tipo}
La investigación es de tipo no experimental, dado que se trabajará con datos históricos comprendidos entre el año 2023 Y 2024. A partir de este análisis, se desarrollará un modelo predictivo para mejorar la precisión en la estimación de la demanda de productos perecibles en Market Donna SAC y, así, orientar decisiones más efectivas. 
...
%	\hline
%%	Dependiente: Demanda de productos perecibles & Cantidad específica de productos perecibles que se espera que los consumidores compren en un período de tiempo determinado, basada en datos históricos de ventas & Cantidad de productos & Número de pedidos \le Demanda\\
%%	\hline
...
%	\begin{tabular}{|L{2.7cm}|L{4cm}|C{1.9cm}|C{2.5cm}|}
	...
	%		\hline
	%		Dependiente: Demanda de productos perecibles & Cantidad específica de productos perecibles que se espera que los consumidores compren en un período de tiempo determinado, basada en datos históricos de ventas & Cantidad de productos & Fórmula 2  \\
	%		\hline
...
%	\begin{table}[ht]
	...
	%Nisi porta lorem mollis aliquam ut porttitor leo. Aenean pharetra magna ac placerat \begin{itemize}
		...
		La recolección de datos para esta investigación se focalizó en la obtención de información sobre la categoría de verduras, la cual representa en promedio el 33 \% de la demanda diaria en Market Donna SAC. Esta categoría fue seleccionada estratégicamente debido a su relevancia en la demanda diaria y su corta vida útil, lo que la convierte en un componente esencial para el análisis de productos perecibles en la empresa.
		...
		Estas estrategias de recolección de datos se diseñaron para ofrecer una visión integral y cuantitativa de la demanda de la categoría de verduras en Market Donna SAC, focalizándose en este grupo de productos perecibles que tiene un impacto significativo en las ventas diarias y en la eficiencia operativa general de la empresa.
		...
		\begin{table}[H]
			...
			\begin{tabular}{|L{2.7cm}|L{2.5cm}|C{2cm}|C{3.5cm}|C{3.5cm}|}
				...
				\hline \hline
				Datos de ventas históricas & Registro de ventas(2023-2024) & Registro de la empresa & Obtiene datos cuantitativos sobre las ventas históricas de productos perecibles & No proporciona informacion cualitativa sobre los patrones de la demanda  \\
				\hline
...
%				\hline
		...
		La investigación incluyó un proceso exhaustivo de exploración, análisis e interpretación de la información recopilada, con el objetivo de identificar patrones, tendencias y relaciones significativas. Este paso es fundamental para garantizar que los datos sean relevantes, precisos y útiles para responder a las preguntas de investigación y alcanzar los objetivos del estudio. El conjunto de datos utilizado abarca 525 mil registros de ventas, organizados por familia de productos, correspondientes a los años 2023 al 2024. Para mayor claridad, se elaboró una tabla que presenta las actividades y tareas realizadas. \ref{tab:compredatos}
		...
		\begin{figure}[H]
			\begin{center}
				...
				\caption{Distribución de precion}
				\textit{Fuente: Elaboración propia}
