...
\begin{itemize}
		...
		\item Fecha de fundación: 2005.
		\item Fundadores o actuales propietarios: Donaciano Paucar. 
		\item Tiendas: 4 tiendas.
		\item Ubicación de cada tienda: Lince, San Miguel, Miraflores, San Juan de Miraflores.
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.8\textwidth]{31/figures/B CANVAS.JPG}
