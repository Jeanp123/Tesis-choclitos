...
\begin{document}
	\begin{titlepage}
		...
		%%%cargar imagen
			...
			\textbf{Predicción de Demanda mediante Modelos de Series Temporales y Machine Learning para la Optimización del Reabastecimiento en la Empresa Donna S.A.C}
			\vspace*{8ex}\\	
