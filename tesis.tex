...
\begin{document}
	\begin{titlepage}
		...
		%%%cargar imagen
			...
			\textbf{Desarrollo de modelo predictivo de la demanda de productos perecibles para la optimización de la toma de decisiones en el pedido de Proveedores en la empresa Market Donna utilizando técnicas de Forecasting}
			\vspace*{8ex}\\	
