...
\subsection{Predicción del precio de Bitcoin mediante análisis comparativo de modelos}
...
\subsection{Effects of data time lag in a decision-making system using machine learning for pork price prediction}
...
\subsection{Construction of performance score dynamic prediction system for clinical departments using explainable machine learning}
...
\subsection{Deep learning-enabled cherry price forecasting and real-time system deployment across multi-market supply chains in India}
...
\subsection{Automated water demand forecasting for national-scale deployment: a prophet-based framework for Palestinian municipal water management}
...
\subsection{Lightweight machine learning framework using temporal features for electric vehicle demand response forecasting on edge devices}
